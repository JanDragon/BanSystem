...
public class MuteHandler {
    ...
    public void mute(CommandSender sender, String reason) {
        ...
        Bukkit.getPluginManager().callEvent(new PlayerMuteEvent(name, sender.getName(), getExactReason(reason), muteHandler.getDuration()));
    ...
    public void reduceMute(String mod, int days) {
        ...
        Bukkit.getPluginManager().callEvent(new MuteReduceEvent(name, moderator.getName(), seconds));
    }
    ...
    public void unMute(CommandSender sender) {
        ...
        Bukkit.getPluginManager().callEvent(new PlayerUnMuteEvent(name, sender.getName()));
    }
