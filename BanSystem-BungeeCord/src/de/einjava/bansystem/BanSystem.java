...
import de.einjava.bansystem.listener.LoginListener;
import de.einjava.bansystem.listener.PlayerDisconnectListener;
import de.einjava.bansystem.listener.PostLoginListener;
...
public class BanSystem extends Plugin {
    ...
    public void onEnable() {
        ...
        System.out.print("                                                       ");
        System.out.print("» BanSystem - by Papiertuch");
        System.out.print("» Version: " + ProxyServer.getInstance().getPluginManager().getPlugin("BanSystem").getDescription().getVersion());
        ...
        Data.teamGroups = Config.getConfiguration().getStringList("Module.CloudNet.Groups");
    ...
    private void register() {
        ...
        pluginManager.registerCommand(this, new BanReduce());
        pluginManager.registerCommand(this, new History());
        pluginManager.registerCommand(this, new Mute());
        pluginManager.registerCommand(this, new Unmute());
        pluginManager.registerCommand(this, new MuteReduce());
